...
template <typename T> inline void autoCompress0(T &v_) { auto comp_ = compressed(v_); for(auto& t : v_) t = idx(t, comp_); }
...
template <typename T2, typename T1> std::vector<T2> castVec(const T1& arr) { std::vector<T2> ret; for(const auto& t : arr) { ret.emplace_back(t); } return ret; }
#pragma endregion
#pragma region math
...
class Frac {
    void reduction() { long long g = std::gcd(numerator, denominator); numerator /= g; denominator /= g; }
public:
    ...
    Frac& operator+=(const long long& i) { numerator += i * denominator; return *this; }
    Frac operator+(const Frac& b) const { Frac ret = *this; ret += b; return ret; }
    Frac operator+(const long long& i) const { Frac ret = *this; ret += i; return ret; }
    Frac& operator-=(const Frac& b) {
        long long l = std::lcm(denominator, b.denominator);
        numerator *= l / denominator; numerator -= b.numerator * (l / b.denominator);
        denominator = l; reduction(); return *this;
    ...
    Frac& operator*=(const long long& i) { numerator *= i; reduction(); return *this; }
    Frac operator*(const Frac& b) const { Frac ret = *this; ret *= b; return ret; }
    Frac operator*(const long long& i) const { Frac ret = *this; ret *= i; return ret; }
    Frac& operator/=(const Frac& b) {
    ...
    Frac& operator/=(const long long& i) {
