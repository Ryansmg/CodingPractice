...
// 19707. RMQ
// #lazyprop #disjoint_set #sorting

v<int> findarray(int, v<int>, v<int>, v<int>) ;
static int N, Q;
int main() {
    scanf("%d%d", &N, &Q);
    v<int> L, R, A;
    forn(i, Q) {
        ...
        L.push_back(l); R.push_back(r); A.push_back(a);
    }
    v<int> ans = findarray(N, L, R, A);
...
v<int> findarray(int n, v<int> L, v<int> R, v<int> A) {
    forn(i, n+10) {
        par.push_back(i);
        sz.push_back(1);
    }
