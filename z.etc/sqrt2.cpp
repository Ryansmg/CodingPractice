...
struct frac {
    ...
    frac operator+(frac o) const {
        frac t = *this;
        o.numerator *= t.denominator;
        t.denominator *= o.denominator;
        t.numerator *= o.denominator;
        t.numerator += o.numerator;
        return t;
    }
    frac operator*(int o) const {
        frac t = *this;
        t.numerator *= o;
        return t;
    }
...
int main() {
    ...
    for(int i=0; i<16; i++) {
        ...
        BigInt g = gcd_(ans.numerator, ans.denominator);
        ans.numerator /= g; ans.denominator /= g;
    }
