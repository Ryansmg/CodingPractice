...
#define endif endprogram //코드 가독성을 위함
#define endfor endprogram
#define endwhile endprogram
#define endprogram } 
...
#define load_all load_pow load_vgcd load_millerrabin
#define VAR_MAX 2147483647
#define VAR_MIN (-VAR_MAX - 1)
#define VLL_MAX 9223372036854775807
#define VLL_MIN (-VLL_MAX - 1)
#define LL_MAX VLL_MAX
#define LL_MIN VLL_MIN
#define VULL_MAX 18446744073709551615
#define ULL_MAX VULL_MAX
#define VULL_MIN 0
#define ULL_MIN VULL_MIN
