...
private:
    vector<Line> tr; vector<signed> l, r; long long ln, rn; long long mode = 1;
public:
...
private:
    void updateAt(long long ul, long long ur, long long pp, long long p, long long s, long long e, const Line& line) {
        ...
        if(!l[p] || l[p] == l[pp]) l[p] = ssize(tr), tr.emplace_back(tr[l[pp]]), l.emplace_back(l[r[pp]]), r.emplace_back(r[r[pp]]);
        if(!r[p] || r[p] == r[pp]) r[p] = ssize(tr), tr.emplace_back(tr[r[pp]]), l.emplace_back(l[l[pp]]), r.emplace_back(r[l[pp]]);
    ...
    void update(const Line& line, long long pp, long long p, long long s, long long e) {
        ...
        if(low[m] < high[m]) {
            tr[p] = low;
            if(!l[p]) l[p] = l[pp];
            if(!r[p] || r[p] == r[pp]) r[p] = ssize(tr), tr.emplace_back(tr[r[pp]]), l.emplace_back(l[r[pp]]), r.emplace_back(r[r[pp]]);
            update(high, r[pp], r[p], m+1, e);
        } else {
            tr[p] = high;
            if(!l[p] || l[p] == l[pp]) l[p] = ssize(tr), tr.emplace_back(tr[l[pp]]), l.emplace_back(l[l[pp]]), r.emplace_back(r[l[pp]]);
            if(!r[p]) r[p] = r[pp];
