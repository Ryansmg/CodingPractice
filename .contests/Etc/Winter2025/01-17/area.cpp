...
f128 ccw(i64 x1, i64 y1, i64 x2, i64 y2, i64 x3, i64 y3) {
...
i32 main() {
    fastio;
    in64(n, x, y);
    v<ii> arr; rep(n-1) arr.pb({qin(2)});
    f128 ans = 0;
    forn(i, n-2) ans += ccw(x, y, arr[i][0], arr[i][1], arr[i+1][0], arr[i+1][1]) / 2;
    printfln(.prec=1)(abs(ans));
}
